...
public class DriveSubsystem extends SubsystemBase implements AutoCloseable {
  ...
  // Drive specs
  public static final Measure<Distance> DRIVE_WHEELBASE = Units.Meters.of(0.5334);
  public static final Measure<Distance> DRIVE_TRACK_WIDTH = Units.Meters.of(0.5334);
